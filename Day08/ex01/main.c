...
int main(void)
{
	...
	while (1)
	{
		cycle(0xE10000FF, 0xE0000000, 0xE0000000);
		cycle(0xE100FF00, 0xE0000000, 0xE0000000);
		cycle(0xE1FF0000, 0xE0000000, 0xE0000000);
		cycle(0xE100FFFF, 0xE0000000, 0xE0000000);
		cycle(0xE1FFFF00, 0xE0000000, 0xE0000000);
		cycle(0xE1FF00FF, 0xE0000000, 0xE0000000);
		cycle(0xE1FFFFFF, 0xE0000000, 0xE0000000);
	}
	return (0);
}
